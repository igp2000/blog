...
import { setArticle, setArticleStored } from '../../store/articles/articlesSlice';
import { selLoaderShow } from '../../store/general/selectors';
import { selArticle, selArticleStored } from '../../store/articles/selectors';
...
const ArticleForm = ({ type }) => {
  ...
  const articleStored = useSelector(selArticleStored);

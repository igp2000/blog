...
import { setMessage, setErrorsServer } from '../../store/message/messageSlice';
import { fetchQuery } from '../../store/general/generalSlice';
import { selLoaderShow } from '../../store/general/selectors';
import { selErrorsServer } from '../../store/message/selectors';
...
const ProfileForm = ({ type }) => {
  ...
  const errorsServer = useSelector(selErrorsServer);
